...
create_clock -period 400.000ns [get_ports ECE385_sys|lantian_mdio:eth0_mdio|counter[1]]
create_clock -period 400.000ns [get_ports ECE385_sys|lantian_mdio:eth1_mdio|counter[1]]
...
set_input_delay -add_delay -max -clock [get_clocks {CLOCK_50}]  3.000 [get_ports {AUD_ADCDAT}]
set_input_delay -add_delay -min -clock [get_clocks {CLOCK_50}]  2.000 [get_ports {AUD_ADCDAT}]
set_input_delay -add_delay -max -clock [get_clocks {CLOCK_50}]  3.000 [get_ports {AUD_ADCLRCK}]
set_input_delay -add_delay -min -clock [get_clocks {CLOCK_50}]  2.000 [get_ports {AUD_ADCLRCK}]
set_input_delay -add_delay -max -clock [get_clocks {CLOCK_50}]  3.000 [get_ports {AUD_BCLK}]
set_input_delay -add_delay -min -clock [get_clocks {CLOCK_50}]  2.000 [get_ports {AUD_BCLK}]
set_input_delay -add_delay -max -clock [get_clocks {CLOCK_50}]  3.000 [get_ports {AUD_DACLRCK}]
set_input_delay -add_delay -min -clock [get_clocks {CLOCK_50}]  2.000 [get_ports {AUD_DACLRCK}]

set_input_delay -add_delay -max -clock [get_clocks {CLOCK_50}]  3.000 [get_ports {I2C_SDAT}]
set_input_delay -add_delay -min -clock [get_clocks {CLOCK_50}]  2.000 [get_ports {I2C_SDAT}]
...
set_output_delay -add_delay  -clock [get_clocks {CLOCK_50}]  2.000 [get_ports {AUD_ADCLRCK}]
set_output_delay -add_delay  -clock [get_clocks {CLOCK_50}]  2.000 [get_ports {AUD_BCLK}]
set_output_delay -add_delay  -clock [get_clocks {CLOCK_50}]  2.000 [get_ports {AUD_DACDAT}]
set_output_delay -add_delay  -clock [get_clocks {CLOCK_50}]  2.000 [get_ports {AUD_DACLRCK}]
...
set_output_delay -add_delay  -clock [get_clocks {CLOCK_50}]  2.000 [get_ports {I2C_SDAT}]

set_output_delay -add_delay  -clock [get_clocks {ECE385_sys|lantian_mdio:eth0_mdio|counter[1]}]  2.000 [get_ports {ENET0_MDC}]
set_output_delay -add_delay  -clock [get_clocks {ECE385_sys|lantian_mdio:eth0_mdio|counter[1]}]  2.000 [get_ports {ENET0_MDIO}]
set_output_delay -add_delay  -clock [get_clocks {ECE385_sys|eth_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {ENET0_RST_N}]
set_output_delay -add_delay  -clock [get_clocks {ECE385_sys|eth_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {ENET0_TX_DATA[0]}]
set_output_delay -add_delay  -clock [get_clocks {ECE385_sys|eth_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {ENET0_TX_DATA[1]}]
set_output_delay -add_delay  -clock [get_clocks {ECE385_sys|eth_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {ENET0_TX_DATA[2]}]
set_output_delay -add_delay  -clock [get_clocks {ECE385_sys|eth_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {ENET0_TX_DATA[3]}]
set_output_delay -add_delay  -clock [get_clocks {ECE385_sys|eth_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {ENET0_TX_EN}]

set_output_delay -add_delay  -clock [get_clocks {ECE385_sys|lantian_mdio:eth1_mdio|counter[1]}]  2.000 [get_ports {ENET1_MDC}]
set_output_delay -add_delay  -clock [get_clocks {ECE385_sys|lantian_mdio:eth1_mdio|counter[1]}]  2.000 [get_ports {ENET1_MDIO}]
set_output_delay -add_delay  -clock [get_clocks {ECE385_sys|eth_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {ENET1_RST_N}]
set_output_delay -add_delay  -clock [get_clocks {ECE385_sys|eth_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {ENET1_TX_DATA[0]}]
set_output_delay -add_delay  -clock [get_clocks {ECE385_sys|eth_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {ENET1_TX_DATA[1]}]
set_output_delay -add_delay  -clock [get_clocks {ECE385_sys|eth_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {ENET1_TX_DATA[2]}]
set_output_delay -add_delay  -clock [get_clocks {ECE385_sys|eth_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {ENET1_TX_DATA[3]}]
set_output_delay -add_delay  -clock [get_clocks {ECE385_sys|eth_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {ENET1_TX_EN}]
